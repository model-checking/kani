...
fn main() {
    ...
    unsafe {
        ...
        // Expect failures
        __VERIFIER_expect_fail(*(data_ptr as *mut i32) != 7, "wrong data");
        __VERIFIER_expect_fail(size_from_vtable(vtable_ptr) != size_of::<i32>());
        __VERIFIER_expect_fail(align_from_vtable(vtable_ptr) != size_of::<i32>());
    }
    ...
    unsafe {
        ...
        // Expect failures
        __VERIFIER_expect_fail(*(data_ptr as *mut i32) != 9, "wrong data");
        __VERIFIER_expect_fail(size_from_vtable(vtable_ptr) != size_of::<i8>());
        __VERIFIER_expect_fail(align_from_vtable(vtable_ptr) != size_of::<i8>());
    }
}
