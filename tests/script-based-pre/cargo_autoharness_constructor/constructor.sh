...
# invariants and reports false alarms; with it, values are generated through the types' own
# constructors (checked public ones, or inlined assert-guarded representation constructors) and
# the false alarms disappear (harnesses are marked "(ctor)").
echo "=== without flag ==="
