...
def add_check_flags(make_group, add_flag):
    ...
    add_flag(group, "--no-default-checks", action="store_true", help="Disable all default checks")
    add_flag(group, "--no-memory-safety-checks", action="store_true", help="Disable default memory safety checks")
    add_flag(group, "--no-overflow-checks", action="store_true", help="Disable default overflow checks")
    add_flag(group, "--no-unwinding-checks", action="store_true", help="Disable default unwinding checks")
