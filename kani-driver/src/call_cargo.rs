...
/// otherwise.
fn packages_to_verify<'b>(args: &VerifyArgs, metadata: &'b Metadata) -> Result<Vec<&'b Package>> {
...
fn package_targets(args: &VerifyArgs, package: &Package) -> Vec<VerificationTarget> {
