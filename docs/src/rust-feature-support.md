...
ptr_guaranteed_eq | Yes | Cannot be overapproximated, performs regular comparison |
ptr_guaranteed_ne | Yes | Cannot be overapproximated, performs regular comparison |
